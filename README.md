...
- Support pricing and occupancy optimization strategies
...
- Reservation status (Cancelled / Not Cancelled)
...
- **Star Schema Modeling** – Data modeling approach
...
- Fact Table: Hotel Data
- Dimension Table: Calendar
- Established relationships for time-based analysis
...
- Repeat guest rate is low (~4.3%)
- 4–7 night stays contribute significantly to revenue
- Cancellations lead to noticeable revenue loss
...
- Maintaining dashboard clarity with multiple filters
